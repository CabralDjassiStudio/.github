...
Les licences sont définies dépôt par dépôt. Les produits commerciaux et systèmes internes sont généralement propriétaires, tandis que certains SDK publics, exemples et composants sélectionnés peuvent utiliser des licences open source propres à leur dépôt.

Les noms, logos, identités de produits, illustrations, mascottes, vidéos et autres éléments de la marque Cabral Djassi Studio ne sont pas automatiquement autorisés à la réutilisation. Consultez la [Politique de marque](../BRAND_POLICY.md) ainsi que la licence de chaque dépôt avant de réutiliser du code ou des éléments de marque.

## Contact

Pour toute information officielle, collaboration, question relative à un produit ou opportunité de partenariat, utilisez les canaux disponibles sur [cabraldjassi.com](https://cabraldjassi.com/).
